    ...
    <div className="bg-white dark:bg-gray-900 py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          {/* 電車アニメーション */}
          <div className="absolute left-6 top-0 w-5 h-8 bg-blue-500 rounded-md shadow-lg z-20 animate-bounce opacity-80">
          ...
          <div className="space-y-16">
            ...
            <div className="relative flex items-center">
              ...
              <div className="relative z-10 group">
                <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-lg transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
              ...
              <div className="ml-8 flex-1">
                <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/30 dark:to-blue-950/30 rounded-lg p-6 shadow-md border-2 border-green-200 dark:border-green-700 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <div className="flex items-center gap-4 mb-4">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">The Foundation Era</h2>
            ...
            <div className="relative flex items-center">
              {/* 駅マーク */}
              <div className="relative z-10 group">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-lg transform transition-all duration-300 hover:scale-110 hover:shadow-xl animate-pulse">
                  <span className="text-white font-bold text-sm">2.0</span>
                </div>
                <div className="absolute -top-2 -right-2">
              ...
              {/* 駅情報板 */}
              <div className="ml-8 flex-1">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-600">
                  <div className="flex items-center gap-4 mb-4">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">The Great Ascension</h2>
                    <div className="flex items-center gap-2">
            ...
            <div className="relative flex items-center">
              {/* 駅マーク */}
              <div className="relative z-10 group">
                <div className="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-lg transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
              ...
              <div className="ml-8 flex-1">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-600">
                  <div className="flex items-center gap-4 mb-4">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">The Digital Renaissance</h2>
                    <div className="flex items-center gap-2">
            ...
            <div className="relative flex items-center">
              {/* 駅マーク */}
              <div className="relative z-10 group">
                <div className="w-16 h-16 bg-pink-500 rounded-full flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-lg transform transition-all duration-300 hover:scale-110 hover:shadow-xl opacity-70">
              ...
              <div className="ml-8 flex-1">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-600">
                  <div className="flex items-center gap-4 mb-4">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">The Empire of Creation</h2>
                    <div className="flex items-center gap-2">
            ...
            {/* 終点マーク */}
            <div className="relative flex items-center">
              <div className="w-16 h-8 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center">
