  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div 
          className="relative bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 pb-4">
            ...
            <button
              onClick={close}
              className="p-1 rounded-lg text-gray-400 hovertext-gray-300 hover:bg-gray-50 transition-colors"
              aria-label="閉じる"
            >
              <X size={20} />
            </button>
