        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2">
            <input
              ...
              value={shareUrl}
              readOnly
              className="flex-1 px-3 py-2 bg-gray-100 rounded-lg text-sm text-gray-700"
            />
            <button
              onClick={handleCopy}
              className={cn(
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
            >
