  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white md:hidden">
      ...
      <div className="flex items-center h-14 px-4 border-b border-gray-200">
        ...
        <button
          onClick={onClose}
          className="p-2 -ml-2 hover:bg-gray-800 rounded-full transition-colors mr-3"
        >
        ...
        <div className="flex-1 relative">
          <input
            ...
            className={cn(
              "w-full pl-4 pr-12 py-2.5 bg-gray-50", 
          ...
          <div className="border-b border-gray-200">
            {suggestions.map((suggestion, index) => (
              <button
                ...
                className="w-full px-4 py-3 text-left hover:bg-gray-800 transition-colors border-b border-gray-100 last:border-b-0"
              >
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-xs text-gray-500 hovertext-gray-300"
                  >
                    クリア
                  </button>
                </div>
